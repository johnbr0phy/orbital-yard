...
const source = fs.readFileSync(path.join(__dirname, '../../armada-three-engine.js'), 'utf8');
...
function loadBattle() {
  ...
  context.ArmadaThree={geometryStore:{gl,geometry:()=>null},engineSource:source,render:()=>{}};
